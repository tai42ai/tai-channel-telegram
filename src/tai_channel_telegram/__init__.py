"""tai-channel-telegram — the Telegram channel plugin for the TAI ecosystem.

A :class:`~tai_contract.channels.Channel` that delivers ``ask_user`` questions
...
package, and :mod:`tai_channel_telegram.register` fires the registrations as a
...
from tai_channel_telegram.settings import TelegramSettings, telegram_settings
